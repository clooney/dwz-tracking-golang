...
func main(){
    ...
    //var postData string ="{\"tracking_number\":\"DWZCN0101810142YQ\"}"
    //httpDo(url,postData,"POST")

    //3 create a tracking number
    var url string ="http://api.trackingmore.com/v2/trackings/post"
    var postData string ="{\"tracking_number\": \"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\",\"title\":\"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"destination_code\":\"US\",\"tracking_ship_date\":\"20180908\",\"tracking_postal_code\":\"12201\",\"lang\":\"en\",\"logistics_channel\":\"API TEST\"}"
    httpDo(url,postData,"POST")

    //4 List all trackings
    //var url string ="http://api.trackingmore.com/v2/trackings/get?page=1&limit=100&created_at_min=&created_at_max=1541314361&update_time_min=&update_time_max=1541314361&order_created_time_min=&order_created_time_max=&numbers=DWZCN0101810142YQ&orders=&lang=en"
    //var postData string =""
    //httpDo(url,postData,"GET")

    //5 Get tracking results of a single tracking
    //var url string ="http://api.trackingmore.com/v2/trackings/dwz/DWZCN0101810142YQ/en"
    //var postData string =""
    //httpDo(url,postData,"GET")
    ...
    //var url string ="http://api.trackingmore.com/v2/trackings/dwz/DWZCN0101810142YQ"
    ...
    //var postData string = "{\"tracking_number\": \"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
    //httpDo(url,postData,"POST")

    //10 Modify courier code
    //var url string ="http://api.trackingmore.com/v2/trackings/update"
    //var postData string = "{\"tracking_number\": \"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\",\"update_carrier_code\":\"china-ems\"}"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"tracking_number\":\"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"carrier_code\":\"dwz\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"tracking_number\":\"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\",\"title\": \"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"logistics_channel\":\"API TEST\",\"destination_code\":\"US\",\"status\":\"7\"},{\"tracking_number1\":\"DWZCN0101810142YQ\",\"carrier_code\":\"dwz\",\"title\": \"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"logistics_channel\":\"API TEST\",\"destination_code\":\"US\",\"status\":\"7\"}]"
    //httpDo(url,postData,"POST")
